...
class NewBias : public Bias {
public:
  explicit NewBias(const ActionOptions&);
  void calculate();
...
NewBias::NewBias(const ActionOptions&ao):
  PLUMED_BIAS_INIT(ao)
{
  checkRead();
